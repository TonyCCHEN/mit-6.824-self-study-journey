...
- Why is consistency so hard to maintain across multiple machines?
- When should a system prefer availability over strong consistency?
- How does replication help fault tolerance without causing too much overhead?

## Next Study Actions

- Rewatch the parts about tradeoffs between consistency, performance, and fault tolerance.
- Read the course notes and compare them with the lecture.
- Prepare for the first MapReduce-related lab by understanding the framework idea.
